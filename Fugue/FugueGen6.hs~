...
allTypesOfChords = [maj7, min7, dom7, dim7, hfd7, augm]
...
allTypesofChordsNames = ["majr","minr","dom7"] -- ["maj7","min7","dom7", {-"hfd7","mnm7",-}"augm"]
...
take2 :: Int -> [a] -> [a]
take2 i a
    | i > length a = take2 (i-1) a --could the right side be just "a"?
    | otherwise    = take i a
...
fugue2Chart :: Fugue -> [[ChordName]]
fugue2Chart = writeChart2 . extractMelodyFromFugues

fugues2Charts :: [Fugue] -> [[[ChordName]]]
fugues2Charts = map fugue2Chart
